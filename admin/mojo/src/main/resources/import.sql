...
CREATE TABLE deep_atom_relationships2 (relationship_id integer(20), component_type VARCHAR(255), terminologyId VARCHAR(255), terminology VARCHAR(255), version VARCHAR(255), relationshipType VARCHAR(255), additionalRelationshipType VARCHAR(255), obsolete BIT(1), suppressible BIT(1), published BIT(1), publishable BIT(1), workflowStatus VARCHAR(255), lastModifiedby VARCHAR(255), lastModified DATETIME, from_atoms_id (20), to_atoms_id integer(20),  INDEX x_from_id (from_atoms_id),  INDEX x_to_id (to_atoms_id) ) ENGINE=INNODB;
CREATE TABLE deep_concept_relationships2 (relationship_id integer(20), component_type VARCHAR(255), terminologyId VARCHAR(255), terminology VARCHAR(255), version VARCHAR(255), relationshipType VARCHAR(255), additionalRelationshipType VARCHAR(255), obsolete BIT(1), suppressible BIT(1), published BIT(1), publishable BIT(1), workflowStatus VARCHAR(255), lastModifiedby VARCHAR(255), lastModified DATETIME, from_concepts_id integer(20), to_concepts_id integer(20),  INDEX x_from_id (from_concepts_id),  INDEX x_to_id (to_concepts_id) ) ENGINE=INNODB;
