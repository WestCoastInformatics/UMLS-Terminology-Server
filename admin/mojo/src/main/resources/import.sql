...
CREATE TABLE deep_atom_relationships (relationship_id BIGINT(20), atoms_id BIGINT(20), component_type VARCHAR(20), role VARCHAR(10), INDEX atoms_ind (atoms_id)) ENGINE=INNODB;
CREATE TABLE deep_concept_relationships (relationship_id BIGINT(20), concepts_id BIGINT(20), component_type VARCHAR(20), role VARCHAR(10), INDEX concepts_ind (concepts_id)) ENGINE=INNODB;