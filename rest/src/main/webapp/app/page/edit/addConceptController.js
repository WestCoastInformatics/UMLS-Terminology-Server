              ...
              var AddConceptModalCtrl = function($scope, $uibModalInstance, contentService, 
                reportService, workflowService, record, project) {
                ...
                $scope.getSearchResults = function(search, clearPaging) {
                  ...
                  contentService.findConcepts("UMLS", "latest", search, 
                    pfs).then(
                  // Success
                  function(data) {
