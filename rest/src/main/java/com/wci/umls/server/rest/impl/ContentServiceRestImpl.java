...
public class ContentServiceRestImpl extends RootServiceRestImpl
  ...
  public ConceptList findAncestorConcepts(
    ...
    try {
      ...
      for (final Concept concept : list.getObjects()) {
        contentService.getGraphResolutionHandler(terminology).resolveEmpty(concept);
      }
  ...
  public CodeList findAncestorCodes(
    ...
    try {
      ...
      for (final Code code : list.getObjects()) {
        contentService.getGraphResolutionHandler(terminology).resolveEmpty(code);
      }
  ...
  public RelationshipList findRelationshipsForComponentInfo(
    ...
    Logger.getLogger(getClass())
        .info("RESTful call (Content): /componentInfo/" + terminology + "/"
