...
public interface HasAlternateTerminologyIds  {
   ...
   * The return value is a map of "terminology" to "terminologyId" 
   * for terminologies other than the components native terminology.
   * For example, the UMLS AUI applied to an atom.
   *
