...
public class MappingJpa extends AbstractComponentHasAttributes implements
  ...
  @Override
  // NOTE: Do not use autogenerated toString, as mapSet.toString references mapping.toString
  public String toString() {
    return "MappingJpa [mapSet=" + (mapSet == null ? "null" : mapSet.getTerminologyId()) + ", fromTerminologyId="
