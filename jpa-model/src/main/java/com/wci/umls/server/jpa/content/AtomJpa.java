...
@Table(name = "atoms", uniqueConstraints = {
		@UniqueConstraint(columnNames = { "terminologyId", "terminology", "version", "id" }),
		@UniqueConstraint(columnNames = { "conceptId", "terminology", "version", "id" }),
		@UniqueConstraint(columnNames = { "codeId", "terminology", "version", "id" }),
		@UniqueConstraint(columnNames = { "descriptorId", "terminology", "version", "id" }),
		@UniqueConstraint(columnNames = { "lexicalClassId", "terminology", "version", "id" }),
		@UniqueConstraint(columnNames = { "stringClassId", "terminology", "version", "id" }),
		@UniqueConstraint(columnNames = { "lowerNameHash", "conceptId", "terminology", "version", "id" }),
		@UniqueConstraint(columnNames = { "terminology", "version", "id" }) })
@Audited
...
public class AtomJpa extends AbstractComponentHasAttributes implements Atom {
	...
	public int hashCode() {
		...
		result = prime * result + (hasPostCoordination ? 1231 : 1237);
	...
	public boolean equals(Object obj) {
		...
		if (leafNode != other.leafNode)
			return false;
		if (hasPostCoordination != other.hasPostCoordination)
			return false;
		if (language == null) {
	...
	public String toString() {
		return "AtomJpa [name=" + name + ", codeId=" + codeId + ", descriptorId=" + descriptorId + ", conceptId="
				+ conceptId + ", language=" + language + ", lexicalClassId=" + ",  leafNode=" + leafNode
				+ ",  hasPostCoordination=" + hasPostCoordination + lexicalClassId + ", stringClassId=" + stringClassId
				+ ", termType=" + termType + ", workflowStatus=" + workflowStatus + ", lastPublishedRank="
				+ lastPublishedRank + "] - " + super.toString();
	}
