...
public class ContentServiceJpa extends MetadataServiceJpa
  ...
  public NoteList findConceptNotesForQuery(String query,
    ...
    final int[] totalCt = new int[1];
    List<ConceptNoteJpa> luceneResults = searchHandler.getQueryResults(null, null,
        "", query, "", ConceptNoteJpa.class, ConceptNoteJpa.class, pfs,
        totalCt, manager);
    results.setTotalCount(totalCt[0]);
  ...
  @Override
  public NoteList findDescriptorNotesForQuery(String query,
    PfsParameter pfs) throws Exception {
    NoteList results = new NoteListJpa();
    SearchHandler searchHandler = this.getSearchHandler(null);
    final int[] totalCt = new int[1];
    List<DescriptorNoteJpa> luceneResults = searchHandler.getQueryResults(null, null,
        "", query, "", DescriptorNoteJpa.class, DescriptorNoteJpa.class, pfs,
        totalCt, manager);
    results.setTotalCount(totalCt[0]);
  ...
  @Override
  public NoteList findCodeNotesForQuery(String query,
    PfsParameter pfs) throws Exception {
    NoteList results = new NoteListJpa();
    SearchHandler searchHandler = this.getSearchHandler(null);
    final int[] totalCt = new int[1];
    List<CodeNoteJpa> luceneResults = searchHandler.getQueryResults(null, null,
        "", query, "", CodeNoteJpa.class, CodeNoteJpa.class, pfs,
        totalCt, manager);
    results.setTotalCount(totalCt[0]);
