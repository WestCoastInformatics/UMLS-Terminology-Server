...
public class ContentServiceJpa extends MetadataServiceJpa implements
  ...
  public SemanticTypeComponent addSemanticTypeComponent(
    ...
    Logger.getLogger(getClass()).debug(
        "Content Service - add semanticTypeComponent " + component);
    // Assign id
    IdentifierAssignmentHandler idHandler = null;
    if (assignIdentifiersFlag) {
  ...
  public void moveAtoms(Concept toConcept, Concept fromConcept,
    ...
    Logger.getLogger(getClass()).debug(
        "Content Service - move atoms " + fromAtoms + " from concept "
  ...
  public ConceptRelationship createInverseConceptRelationship(
    ...
    Logger.getLogger(getClass()).debug(
        "Content Service - create inverse of concept relationship "
            + relationship);
    if (relationship != null) {
      ...
      inverseRelationship.setRelationshipType(getRelationshipType(
