...
/**
 * The Class SeclUtility.
 */
public class EclUtility {

  /**
   * The Enum InternalFunction.
   */
   ...
   */
  // add Class<? extends AtomClass>, conctentService
  public static String parse(String ecQuery) throws RecognitionException {
    ...
    parser.setErrorHandler(new ANTLRErrorStrategy() {
      ...
      @Override
      public boolean inErrorRecoveryMode(org.antlr.v4.runtime.Parser arg0) {
        // Not used, override required
        return false;
      }

      @Override
      public void recover(org.antlr.v4.runtime.Parser arg0,
        org.antlr.v4.runtime.RecognitionException arg1)
      ...
      @Override
      public org.antlr.v4.runtime.Token recoverInline(
        org.antlr.v4.runtime.Parser arg0)
          throws org.antlr.v4.runtime.RecognitionException {
        // Not used, override required
        return null;
      }
      ...
      @Override
      public void reportError(org.antlr.v4.runtime.Parser arg0,
        org.antlr.v4.runtime.RecognitionException arg1) {
        // Not used, override required
      ...
      @Override
      public void reportMatch(org.antlr.v4.runtime.Parser arg0) {
        // Not used, override required

      }

      @Override
      public void reset(org.antlr.v4.runtime.Parser arg0) {
        // Not used, override required

      }

      @Override
      public void sync(org.antlr.v4.runtime.Parser arg0)
        throws org.antlr.v4.runtime.RecognitionException {
        // Not used, override required
    ...
    final LocalExpressionConstraintListener listener =
        new LocalExpressionConstraintListener();
   ...
   */
  protected static final class LocalExpressionConstraintListener
      extends ExpressionConstraintBaseListener {
     ...
     * 
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterSimpleexpressionconstraint(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.SimpleexpressionconstraintContext)
     */
    @Override
    public void enterSimpleexpressionconstraint(
      ...
      if (focusconcept.wildcard() != null) {
        ...
        luceneQuery += ConceptFieldNames.MEMBER_OF + ":"
        ...
        if (constraintoperator == null) {
          ...
          if (constraintoperator.descendantof() != null) {
            if (!inAttribute) {
              ...
              luceneQuery += InternalFunction.ATTRIBUTE_DESCENDANT_OF + "("
                  + conceptId + ")";
            }
          } else if (constraintoperator.descendantorselfof() != null) {
            if (!inAttribute) {
              luceneQuery += "(" + ConceptFieldNames.ID + ":" + conceptId
                  + " OR " + ConceptFieldNames.ANCESTOR + ":" + conceptId + ")";
            } else {
              luceneQuery += InternalFunction.ATTRIBUTE_DESCENDANT_OR_SELF_OF
                  + "(" + conceptId + ")";
            }
            ...
            if (!inAttribute) {
              ...
              luceneQuery += InternalFunction.ATTRIBUTE_ANCESTOR_OR_SELF_OF
                  + "(" + conceptId + ")";
            }
            ...
            if (!inAttribute) {
              ...
              luceneQuery += InternalFunction.ATTRIBUTE_ANCESTOR_OF + "("
                  + conceptId + ")";
            }
          }
        }
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterRefinement(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.RefinementContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterAttribute(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.AttributeContext)
     */
    @Override
    public void enterAttribute(
      ExpressionConstraintParser.AttributeContext ctx) {
      inAttribute = true;
    }
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * exitAttribute(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.AttributeContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterAttributename(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.AttributenameContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterExpressioncomparisonoperator(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.ExpressioncomparisonoperatorContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterConjunction(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.ConjunctionContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterDisjunction(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.DisjunctionContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterExclusion(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.ExclusionContext)
     */
    @Override
    public void enterExclusion(
      ExpressionConstraintParser.ExclusionContext ctx) {
      luceneQuery += " NOT ";
    }
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterSubexpressionconstraint(com.wci.umls.server.jpa.services.secl.
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * exitSubexpressionconstraint(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.SubexpressionconstraintContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterSubrefinement(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.SubrefinementContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * exitSubrefinement(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.SubrefinementContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterSubattributeset(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.SubattributesetContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterExpressionconstraintvalue(com.wci.umls.server.jpa.services.secl.
    ...
    public void enterExpressionconstraintvalue(
      ...
      if (ctx.refinedexpressionconstraint() != null
          || (ctx.compoundexpressionconstraint() != null
              && ctx.compoundexpressionconstraint().getText().contains(":"))) {
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * exitExpressionconstraintvalue(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.ExpressionconstraintvalueContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * exitSubattributeset(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.SubattributesetContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterCardinality(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.CardinalityContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterAttributegroup(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.AttributegroupContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterStringcomparisonoperator(com.wci.umls.server.jpa.services.secl.
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterNumericcomparisonoperator(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.NumericcomparisonoperatorContext)
     */
    @Override
     ...
     * @see
     * com.wci.umls.server.jpa.services.secl.ExpressionConstraintBaseListener#
     * enterReverseflag(com.wci.umls.server.jpa.services.secl.
     * ExpressionConstraintParser.ReverseflagContext)
     */
    @Override
