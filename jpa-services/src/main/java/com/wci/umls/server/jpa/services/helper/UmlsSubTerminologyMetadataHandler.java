 ...
 */
public class UmlsSubTerminologyMetadataHandler extends DefaultMetadataHandler {
  ...
  /**
   * Instantiates an empty {@link UmlsSubTerminologyMetadataHandler}.
   *
   * @throws Exception the exception
   */
  public UmlsSubTerminologyMetadataHandler() throws Exception {
    super();
    refreshCachesHelper();
  }
  ...
  public String getName() {
    return "Umls Sub-terminology Metadata Handler";
  }
