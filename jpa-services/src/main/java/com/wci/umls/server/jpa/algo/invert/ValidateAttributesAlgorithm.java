 ...
 */
public class ValidateAttributesAlgorithm extends AbstractInsertMaintReleaseAlgorithm {
  ...
  public ValidationResult checkPreconditions() throws Exception {
    ...
    if (getProject() == null) {
      throw new LocalException("Attribute Validation requires a project to be set");
    }
  ...
  public List<AlgorithmParameter> getParameters() throws Exception {
    ...
    AlgorithmParameter param = new AlgorithmParameterJpa("Validation Checks", "checkNames",
        "The names of the validation checks to run", "e.g. #ATTS_1", 200,
        AlgorithmParameter.Type.MULTI, "");

    List<String> validationChecks = new ArrayList<>();
    validationChecks.add("#ATTS_1");
    validationChecks.add("#ATTS_2");
    validationChecks.add("#ATTS_3");
    validationChecks.add("#ATTS_4");
    validationChecks.add("#ATTS_5");
    validationChecks.add("#ATTS_6");
    validationChecks.add("#ATTS_7");
    validationChecks.add("#ATTS_8");
    validationChecks.add("#ATTS_9");
    validationChecks.add("#ATTS_10");
