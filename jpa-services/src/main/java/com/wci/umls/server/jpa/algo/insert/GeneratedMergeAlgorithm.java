...
public class GeneratedMergeAlgorithm extends AbstractMergeAlgorithm {
  ...
  public void compute() throws Exception {
    ...
    // If this is a Mid-Merge, prepend the lastModifiedBy with "ENG-"
    if(midMerge){
  ...
  public List<AlgorithmParameter> getParameters() {
    ...
    // New mid merge flag
    param = new AlgorithmParameterJpa("Mid Merge", "midMerge",
        "Is this a mid-merge?", "e.g. true", 5,
        AlgorithmParameter.Type.BOOLEAN, "false");
    params.add(param);    
