...
public class QueryActionAlgorithm extends AbstractSourceInsertionAlgorithm {
  ...
  public void compute() throws Exception {
    logInfo("Starting QUERYACTION: " + action + " " + objectTypeClass.getSimpleName());

    // No Molecular actions will be generated by this algorithm
    setMolecularActionFlag(false);

    logInfo("[QueryAction]: " + action + " " + objectTypeClass.getSimpleName() + " for results of "
    ...
    logInfo("[QueryAction] " + successfulActions + " " + action + " "
        + objectTypeClass.getSimpleName() + " actions successfully performed.");
