...
public class AttributeLoaderAlgorithm extends AbstractAlgorithm {
  ...
  public void compute() throws Exception {
    ...
    // Count number of added and updated Attributes, for logging
    int addCount = 0;
    int updateCount = 0;
    ...
    try {
      ...
      logInfo("[AttributeLoader] Checking for new/updated Attributes");
      ...
      logInfo("[AttributeLoader] Added " + addCount + " new Attributes.");
      logInfo(
          "[AttributeLoader] Updated " + updateCount + " existing Attributes.");
