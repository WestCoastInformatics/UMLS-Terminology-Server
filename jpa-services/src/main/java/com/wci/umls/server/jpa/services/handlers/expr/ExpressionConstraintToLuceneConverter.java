 ...
 * 
 * NOTE: Adapted from Kai Kewley's SNOMED Query Service
 * at https://github.com/IHTSDO/snomed-query-service
 */
public class ExpressionConstraintToLuceneConverter {

    /**
     * The Enum InternalFunction.
     * NOTE: Changed to public from SQS and comments added
     */
    ...
    /**
     * The listener interface for receiving expressionConstraint events.
     * The class that is interested in processing a expressionConstraint
     * event implements this interface, and the object created
     * with that class is registered with a component using the
     * component's <code>addExpressionConstraintListener<code> method. When
    ...
    protected static final class ExpressionConstraintListener extends ExpressionConstraintBaseListener {
        ...
        public void enterSimpleexpressionconstraint(ExpressionConstraintParser.SimpleexpressionconstraintContext ctx) {
            ...
            if (focusconcept.wildcard() != null) {
                ...
                luceneQuery += EclConceptFieldNames.MEMBER_OF + ":" + focusconcept.conceptreference().conceptid().getText();
            } else {
                ...
                if (constraintoperator == null) {
                    ...
                    if (constraintoperator.descendantof() != null) {
                        ...
                        if (!inAttribute) {
                            luceneQuery += "(" + EclConceptFieldNames.ID + ":" + conceptId + " OR " + EclConceptFieldNames.ANCESTOR + ":" + conceptId + ")";
                        } else {
