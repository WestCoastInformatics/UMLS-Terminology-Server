...
public class ContextLoaderAlgorithm extends AbstractSourceLoaderAlgorithm {
  ...
  private void loadContexts(String line) throws Exception {
    ...
    if (!fields[12].equals(fields[15])) {
      logWarnAndUpdate(line,
          "Warning - type 1: " + fields[12] + " does not equals type 2: "
              + fields[15] + ".");
      return;
    }
    ...
    final String parentTreeRel = fields[7];
    final IdType idType = lookupIdType(fields[12]);
    ...
    for (String element : ptrAltIds) {
      ...
      final Long atomId =
          getId(IdType.ATOM, element, specifiedTerm.getTerminology());
    ...
    createTreePositions(idType, nodeAtom, parentTreeRel, fields[6]);
  }
   ...
   * @throws Exception the exception
   */
  private void createTreePositions(IdType idType, Atom nodeAtom,
